...
@section('content')
    ...
    <div>
        <h1 class="page-title"> Aprobadores </h1>
        <div class="page-bar">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Aprobadores</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <button href="{!! route('approvers.create') !!}" data-target="#addEditItem" data-toggle="modal" class="btn sbold green"> Agregar
