<div class="form-body">
    ...
    <div class="form-group form-md-line-input">
        <label class="col-md-3 control-label" for="form_control_1">Concepto
            <span class="required">*</span>
        </label>
        <div class="col-md-6">
            {!! Form::select('concept_id',$concepts, null, ['class' => 'form-control select2','required']) !!}
    ...
    <div class="form-group form-md-line-input">
        ...
        <div class="col-md-6">
            {!! Form::select('sub_concept_id',$sub_concepts, null, ['class' => 'form-control select2','required']) !!}
            <div class="form-control-focus"> </div>
        </div>
    </div>

    <div class="form-group form-md-line-input">
        <label class="col-md-3 control-label" for="form_control_1">Categoria de Concepto
            <span class="required">*</span>
        </label>
        <div class="col-md-6">
