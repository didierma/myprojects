...
@section('content')
    ...
    <div>
        <h1 class="page-title"> Sub Categoria Conceptos
            <small>Administrar Sub Categoria Conceptos</small>
        </h1>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Sub Categoria de Conceptos</span>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Sub Categoria Conceptos</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <button href="{!! route('sub_concept_categories.create') !!}" data-target="#addEditItem" data-toggle="modal" class="btn sbold green"> Agregar
                        ...
                        @include('sub_concept_categories.table')
                    </div>
                </div>
            </div>
        </div>
