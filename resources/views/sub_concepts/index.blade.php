...
@section('content')
    ...
    <div>
        <h1 class="page-title"> Sub Conceptos
            <small>Administrar Sub Conceptos</small>
        </h1>
        <div class="page-bar">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Sub Conceptos</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <button href="{!! route('sub_concepts.create') !!}" data-target="#addEditItem" data-toggle="modal" class="btn sbold green"> Agregar
